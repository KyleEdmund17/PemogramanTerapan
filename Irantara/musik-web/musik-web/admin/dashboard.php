...
<div class="app">
  ...
  <main class="main">
    ...
    <section class="card" style="margin-bottom:20px">
      <h3>Upload Lagu</h3>
        <form action="upload.php" method="POST" enctype="multipart/form-data" class="upload-card">

          <input type="text" name="title" placeholder="Judul Lagu" required>
          <input type="text" name="artist" placeholder="Pencipta / Seniman" required>
          ...
          <button class="btn primary">⬆ Upload Lagu</button>
        </form>
